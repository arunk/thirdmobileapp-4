"""
Django settings for thirdmobileapp_4 project.
...
ROOT_URLCONF = 'thirdmobileapp_4.urls'
...
WSGI_APPLICATION = 'thirdmobileapp_4.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "thirdmobileapp_4 API",
    "DESCRIPTION": "API documentation for thirdmobileapp_4 App",
    "VERSION": "v1",
}
